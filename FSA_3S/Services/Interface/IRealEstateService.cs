...
namespace FSA_3S.Services.Interface
{
    public interface IRealEstateService
    {
        ...
        Task<RealEstateRespone> UpdateApprovalStatusAsync(int id, ApprovalStatusRequest request);
        Task<IEnumerable<RealEstateRespone>> GetAllMappingsApprovalStatusAsync();
    }
}