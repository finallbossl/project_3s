...
namespace FSA_3S.Repositories.Repository
{
    public class RealEstateRepository(AppDbContext context) : IRealEstateRepository
    {
        ...
        public async Task<RealEstateEntity> UpdateApprovalStatusAsync(RealEstateEntity realEstate)
        {
            _context.RealEstates.Update(realEstate);
            await _context.SaveChangesAsync();
            return realEstate;
        ...
        public async Task<IEnumerable<RealEstateEntity>> GetAllApprovalStatusAsync()
        {
            return await _context.RealEstates
                .Include(r => r.Creator)
                .Include(r => r.Updater)
